...
public class Shop : MonoBehaviour
{
    ...
    public void Item1Open()
    {
        ...
        Item2.GetComponent<Image>().sprite = OrangeImage;
        Item3.GetComponent<Image>().sprite = OrangeImage;
        Item4.GetComponent<Image>().sprite = OrangeImage;
    ...
    public void Item2Open()
    {
        ...
        Item1.GetComponent<Image>().sprite = OrangeImage;
    ...
    public void Lock3Open()
    {
        ...
        if (money >= 1500 && lock3control == 0)
        {
            Lock1.SetActive(false);
            PlayerPrefs.SetInt("moneyy", money - 1500);
